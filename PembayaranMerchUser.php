...
<head>
    ...
    <title>Pembayaran Merchandise User</title>
    ...
    <div class="card">
        <div class="row">
            <div class="col-md-8 cart">
                <div class="title">
                    <div class="row">
                        <div class="col"><h4><b>Shopping Cart User</b></h4></div>
                ...
                <div class="row border-top border-bottom">
                    <div class="row main align-items-center">
                        ...
                        <div class="col"> Rp.200.000,00 <span class="close">&#10005;</span></div>
                    </div>
                </div>
                <div class="row">
                    <div class="row main align-items-center">
                        ...
                        <div class="col">Rp.175.000,00 <span class="close">&#10005;</span></div>
                    </div>
                </div>
                <div class="back-to-shop"><a href="#">&leftarrow;</a><span class="text-muted">Back to shop</span></div>
            </div>
            <div class="col-md-4 summary" style="background-color: #014638;color: white;">
                <div><h5 style="color: white;"><b>Pembayaran</b></h5></div>
                <hr>
                <div class="row">
                    <div class="col" style="padding: left 1px;;">ITEMS 2</div>
                    <div class="col text-right">Rp.375.000,00</div>
                </div>
                <form>
                ...
                <div class="row" style="border-top: 1px solid rgba(0,0,0,.1); padding: 2vh 0;">
                    ...
                    <div class="col text-right">Rp.385.000,00</div>
                </div>
                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                    <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="checkout.html" style="background-color: #F1FF46;">CHECKOUT !</a></div>
                </div>
        </div>
